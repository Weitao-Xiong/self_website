...
export const profileConfig: ProfileConfig = {
	...
	name: "Weitao Xiong",
	bio: "Stay curious, keep learning.",
	links: [
		{
			name: "Google Scholar",
			icon: "fa6-brands:google-scholar",
			url: "https://scholar.google.com/citations?user=pgOy3m4AAAAJ&hl=zh-CN",
		},
		{
			name: "GitHub",
			icon: "fa6-brands:github",
			url: "https://github.com/Weitao-Xiong",
		},
		{
			name: "Steam",
			icon: "fa6-brands:steam",
			url: "https://steamcommunity.com/profiles/76561199193857268/",
		},
	],
};
